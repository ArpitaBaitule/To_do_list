...
if __name__ == "__main__":  
    ...
    # setting the background color to ##F4F70E 
    guiWindow.configure(bg = "#F4F70E")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#F4F70E")  
    listbox_frame = tk.Frame(guiWindow, bg = "#F4F70E")  
    functions_frame = tk.Frame(guiWindow, bg = "#F4F70E")  
